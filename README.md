...
> 随时更新，欢迎大家的批评与指导
 ...
 - Redis实战
  ...
  - 图解HTTP
    ...
    * 第四章 [返回结果的HTTP状态码](https://github.com/havenBoy/java-book-notes/blob/master/%E5%9B%BE%E8%A7%A3HTTP/fourth.md)
    * 第五章 [与HTTP协作的web服务器](https://github.com/havenBoy/java-book-notes/blob/master/%E5%9B%BE%E8%A7%A3HTTP/fifth.md)
    * 第六章 [HTTP首部](https://github.com/havenBoy/java-book-notes/blob/master/%E5%9B%BE%E8%A7%A3HTTP/sixth.md)
    * 第七章 [确保安全的HTTPS](https://github.com/havenBoy/java-book-notes/blob/master/%E5%9B%BE%E8%A7%A3HTTP/seventh.md)
    * 第八章 [确认访问用户的身份的验证](https://github.com/havenBoy/java-book-notes/blob/master/%E5%9B%BE%E8%A7%A3HTTP/eighth.md)
    * 
